<footer class="text-center lg:text-left bg-gray-100 text-gray-600 mt-16">
    ...
    <div class="mx-6 py-10 text-center md:text-left">
        <div class="grid grid-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            <div class="">
                ...
                <p>
                    Lorem ipsum dolor sit amet, consectetur adipisicing elit. At autem beatae corporis doloribus error excepturi harum, magni molestiae non, nostrum obcaecati quae quam quasi repellat
                    sapiente tempore tenetur unde voluptas?
                </p>
            </div>
            <div class="">
                ...
                <p class="mb-4">
                    <a href="#!" class="text-gray-600">Recipe</a>
                </p>
                <p class="mb-4">
                    <a href="#!" class="text-gray-600">Shoppingcart</a>
                </p>
                <p class="mb-4">
                    <a href="#!" class="text-gray-600">Bob</a>
                </p>
                <p>
                    <a href="#!" class="text-gray-600">Bob</a>
                </p>
    ...
    <div class="text-center p-6 bg-gray-200">
        ...
        <a class="text-gray-600 font-semibold" href="http://gilbert.wexox.no/">Gilbert</a>
    </div>
